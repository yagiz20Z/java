...
public class SOCKETclient {
    public static void main(String[] args) throws Exception
    {
        ...
        String ip = "172.15.3.74";
        int port = 15000; // 0-65535 // ama 0-1023 arasındaki portlar sistem için özel olarak ayrılmış durumdadır // ideali porlar 1023-65535 arasındadır
